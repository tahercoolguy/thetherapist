...
//    private final List<SliderData> mSliderItems;
    ...
    ArrayList<Users> eventsDetailsData;
    Activity context;
    ...
    // Constructor
    public SliderHomeAdapter(Activity context, ArrayList<Users> eventsDetailsData,SliderView sliderView) {
...
//        viewHolder.img.setImageResource(eventsDetailsData.get(position).getImage());
        Picasso.with(context).load("http://207.154.215.156:8000"+eventsDetailsData.get(position).getImage()).into(viewHolder.fontRoundedimg);
        Picasso.with(context).load("http://207.154.215.156:8000"+eventsDetailsData.get(position).getImage()).into(viewHolder.bgRoundedimg);
