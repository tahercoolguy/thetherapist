...
public class Adapter_Search_Select extends RecyclerView.Adapter<Adapter_Search_Select.ViewHolder> {
    ...
    public Adapter_Search_Select(Context context, ArrayList<SearchDM> arrayList) {
    ...
    @NonNull
    @Override
    public Adapter_Search_Select.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.custum_item_search, parent, false);
        // set the view's size, margins, paddings and layout parameters
        Adapter_Search_Select.ViewHolder vh = new Adapter_Search_Select.ViewHolder(v);
        return vh;
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_Search_Select.ViewHolder holder, int position) {
